...
//Last modified: Mon, Feb 03, 2014 04:59:07 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.3784978540026755 22.984606138651092 18.656227150606554 ;
	...
	setAttr ".rpt" -type "double3" -6.4409147401579535e-016 1.2364862536327072e-015 
		-7.6959612392825558e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 32.736410846621041;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.22751804186954327 -1.7966950120259675 -2.5856513571669701 ;
...
createNode transform -n "locator1";
	...
	setAttr -av -k on ".FrameNumber" 16;
...
createNode mesh -n "Scene5Shape" -p "Scene5";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.9954656171323979 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode mesh -n "Scene6Shape" -p "Scene6";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.92005926370620728 0 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode mesh -n "Scene9Shape" -p "Scene9";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.95697609852768695 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode animCurveTU -n "locator1_visibility";
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 1 10 1 20 1 30 1 40 1 50 1 60 1 70 1 80 1
		 90 1 100 1 110 1 120 1 130 1 140 1 150 1 160 1;
	setAttr -s 17 ".kit[0:16]"  9 1 1 9 9 9 9 9 
		9 9 9 9 9 9 9 9 9;
...
createNode animCurveTL -n "locator1_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 -10 10 -10 20 -10 30 -10 40 -10 50 -10
		 60 -10 70 -10 80 -10 90 -10 100 -10 110 -10 120 -10 130 -10 140 -10 150 -10 160 -10;
...
createNode animCurveTL -n "locator1_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 0 10 0 20 0 30 0 40 0 50 0 60 0 70 0 80 0
...
createNode animCurveTL -n "locator1_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 -8 10 -8 20 -8 30 -8 40 -8 50 -8 60 -8
		 70 -8 80 -8 90 -8 100 -8 110 -8 120 -8 130 -8 140 -8 150 -8 160 -8;
	setAttr -s 17 ".kit[1:16]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18 18 18 18;
	setAttr -s 17 ".kot[1:16]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18 18 18 18;
...
createNode animCurveTU -n "locator1_FrameNumber";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 0 10 1 20 2 30 3 40 4 50 5 60 6 70 7 80 8
		 90 9 100 10 110 11 120 12 130 13 140 14 150 15 160 16;
	setAttr -s 17 ".kit[1:16]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18 18 18 18;
	setAttr -s 17 ".kot[1:16]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18 18 18 18;
	setAttr -s 17 ".kix[1:16]"  0.08304547518491745 1 0.38461533188819885 
		0.38461536169052124 0.38461542129516602 0.3846154510974884 0.38461536169052124 0.38461536169052124 
		0.38461536169052124 0.38461548089981079 0.3846154510974884 0.38461527228355408 0.38461548089981079 
		0.3846154510974884 0.38461527228355408 1;
	setAttr -s 17 ".kiy[1:16]"  0.99654573202133179 0 0.92307686805725098 
		0.92307698726654053 0.92307698726654053 0.92307686805725098 0.92307692766189575 0.92307692766189575 
		0.92307692766189575 0.92307692766189575 0.92307692766189575 0.92307698726654053 0.92307692766189575 
		0.92307692766189575 0.92307698726654053 0;
	setAttr -s 17 ".kox[1:16]"  0.08304547518491745 1 0.38461536169052124 
		0.38461536169052124 0.38461539149284363 0.3846154510974884 0.38461536169052124 0.38461536169052124 
		0.38461536169052124 0.3846154510974884 0.38461548089981079 0.38461527228355408 0.3846154510974884 
		0.38461548089981079 0.38461527228355408 1;
	setAttr -s 17 ".koy[1:16]"  0.99654573202133179 0 0.92307692766189575 
		0.92307698726654053 0.92307686805725098 0.92307686805725098 0.92307692766189575 0.92307692766189575 
		0.92307692766189575 0.92307692766189575 0.92307692766189575 0.92307698726654053 0.92307692766189575 
		0.92307692766189575 0.92307698726654053 0;
