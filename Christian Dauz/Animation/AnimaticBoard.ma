...
//Last modified: Tue, Jan 28, 2014 05:26:21 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.2831404722024837 57.681794098625389 47.724893254355869 ;
	setAttr ".r" -type "double3" -48.000000000000433 3.200000000000661 0 ;
	setAttr ".rp" -type "double3" -8.8817841970012523e-016 0 -7.1054273576010019e-015 ;
	setAttr ".rpt" -type "double3" -1.2356845194265418e-016 -6.2545031753961293e-015 
		4.1293368095553561e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 78.978393410462672;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 7.3216385275828975 2.5615430416275515 -5.403508348120905 ;
...
connectAttr "polyPlane1.out" "Scene1Shape.i";
...
connectAttr "Scene3Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene4Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene5Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene6Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene7Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene8Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene9Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene10Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene11Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene12Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene13Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene14Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene15Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene16Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene17Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene18Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene19Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene20Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene21Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene22Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene23Shape.iog" "lambert3SG.dsm" -na;
connectAttr "Scene24Shape.iog" "lambert3SG.dsm" -na;
