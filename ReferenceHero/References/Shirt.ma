...
//Name: Shirt.ma
//Last modified: Tue, Oct 01, 2013 11:03:02 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.4650873181241693 18.423010894423605 15.654244809489473 ;
	setAttr ".r" -type "double3" -27.938352730530006 -733.7999999998741 8.1877314683962917e-016 ;
...
createNode blinn -n "Black_Leather";
...
connectAttr "polyExtrudeFace5.out" "ShirtShape.i";
connectAttr "groupId2.id" "ShirtShape.iog.og[0].gid";
connectAttr "blinn2SG.mwc" "ShirtShape.iog.og[0].gco";
connectAttr "groupId4.id" "ShirtShape.iog.og[1].gid";
connectAttr "blinn1SG.mwc" "ShirtShape.iog.og[1].gco";
connectAttr "groupId5.id" "ShirtShape.iog.og[2].gid";
connectAttr "blinn2SG.mwc" "ShirtShape.iog.og[2].gco";
connectAttr "groupId3.id" "ShirtShape.ciog.cog[0].cgid";
...
connectAttr "ShirtShape.wm" "polyExtrudeFace1.mp";
connectAttr "polyCube1.out" "polyTweak1.ip";
connectAttr "polyExtrudeFace1.out" "polyExtrudeFace2.ip";
connectAttr "ShirtShape.wm" "polyExtrudeFace2.mp";
...
connectAttr "Red_Collar.oc" "blinn1SG.ss";
connectAttr "groupId4.msg" "blinn1SG.gn" -na;
connectAttr "ShirtShape.iog.og[1]" "blinn1SG.dsm" -na;
connectAttr "blinn1SG.msg" "materialInfo1.sg";
connectAttr "Red_Collar.msg" "materialInfo1.m";
...
connectAttr "leather1.oc" "Black_Leather.c";
connectAttr "Black_Leather.oc" "blinn2SG.ss";
connectAttr "ShirtShape.iog.og[0]" "blinn2SG.dsm" -na;
connectAttr "ShirtShape.iog.og[2]" "blinn2SG.dsm" -na;
connectAttr "blinn2SG.msg" "materialInfo2.sg";
connectAttr "Black_Leather.msg" "materialInfo2.m";
connectAttr "leather1.msg" "materialInfo2.t" -na;
connectAttr "place3dTexture1.wim" "leather1.pm";
connectAttr "polyTweak4.out" "polyExtrudeFace3.ip";
connectAttr "ShirtShape.wm" "polyExtrudeFace3.mp";
...
connectAttr "ShirtShape.wm" "polyExtrudeFace4.mp";
...
connectAttr "ShirtShape.wm" "polyExtrudeFace5.mp";
connectAttr "deleteComponent4.og" "polyTweak8.ip";
connectAttr "blinn1SG.pa" ":renderPartition.st" -na;
connectAttr "blinn2SG.pa" ":renderPartition.st" -na;
connectAttr "ShirtShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "groupId2.msg" ":initialShadingGroup.gn" -na;
connectAttr "groupId3.msg" ":initialShadingGroup.gn" -na;
connectAttr "groupId5.msg" ":initialShadingGroup.gn" -na;
connectAttr "Red_Collar.msg" ":defaultShaderList1.s" -na;
connectAttr "Black_Leather.msg" ":defaultShaderList1.s" -na;
